...
const services_buttonProps = useStore((state)=>state["Home"]["services_button"]);
const services_buttonIoProps = useIoStore((state)=>state["Home"]["services_button"]);
const services_buttonCb = useservices_buttonCb()
const Button5Props = useStore((state)=>state["Home"]["Button5"]);
const Button5IoProps = useIoStore((state)=>state["Home"]["Button5"]);
const Button5Cb = useButton5Cb()
const blog_buttonProps = useStore((state)=>state["Home"]["blog_button"]);
const blog_buttonIoProps = useIoStore((state)=>state["Home"]["blog_button"]);
const blog_buttonCb = useblog_buttonCb()
const bookacall_buttonProps = useStore((state)=>state["Home"]["bookacall_button"]);
const bookacall_buttonIoProps = useIoStore((state)=>state["Home"]["bookacall_button"]);
const bookacall_buttonCb = usebookacall_buttonCb()
...
<Button className="p-Home about_button bpt" {...about_buttonProps} {...about_buttonCb} {...about_buttonIoProps}/>
<Button className="p-Home services_button bpt" {...services_buttonProps} {...services_buttonCb} {...services_buttonIoProps}/>
<Button className="p-Home Button5 bpt" {...Button5Props} {...Button5Cb} {...Button5IoProps}/>
<Button className="p-Home blog_button bpt" {...blog_buttonProps} {...blog_buttonCb} {...blog_buttonIoProps}/>
<Button className="p-Home bookacall_button bpt" {...bookacall_buttonProps} {...bookacall_buttonCb} {...bookacall_buttonIoProps}/>
</Flex>
</Flex>
</Div>
