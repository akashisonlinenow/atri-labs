...
export function useabout_buttonCb() {
	const onClick = useCallback(callbackFactory("about_button", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
...
export function useservices_buttonCb() {
	const onClick = useCallback(callbackFactory("services_button", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
...
export function useblog_buttonCb() {
	const onClick = useCallback(callbackFactory("blog_button", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
...
export function usebookacall_buttonCb() {
	const onClick = useCallback(callbackFactory("bookacall_button", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
