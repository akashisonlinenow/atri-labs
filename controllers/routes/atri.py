...
class Atri:
	def __init__(self, state: Any):
		...
		self.home-hero-section = state["home-hero-section"]
		...
		self.services_button = state["services_button"]
		self.Button5 = state["Button5"]
		self.blog_button = state["blog_button"]
		self.bookacall_button = state["bookacall_button"]
	...
	@property
	def home-hero-section(self):
		self._getter_access_tracker["home-hero-section"] = {}
		return self._home-hero-section
	@home-hero-section.setter
	def home-hero-section(self, new_state):
		self._setter_access_tracker["home-hero-section"] = {}
		global default_state
		self._home-hero-section = Flex(new_state, default_state["home-hero-section"])
	...
	def about_button(self, new_state):
		...
		global default_state
		self._about_button = Button(new_state, default_state["about_button"])

	@property
	def services_button(self):
		self._getter_access_tracker["services_button"] = {}
		return self._services_button
	@services_button.setter
	def services_button(self, new_state):
		self._setter_access_tracker["services_button"] = {}
		global default_state
		self._services_button = Button(new_state, default_state["services_button"])
	...
	def blog_button(self):
		self._getter_access_tracker["blog_button"] = {}
		return self._blog_button
	@blog_button.setter
	def blog_button(self, new_state):
		self._setter_access_tracker["blog_button"] = {}
		global default_state
		self._blog_button = Button(new_state, default_state["blog_button"])

	@property
	def bookacall_button(self):
		self._getter_access_tracker["bookacall_button"] = {}
		return self._bookacall_button
	@bookacall_button.setter
	def bookacall_button(self, new_state):
		self._setter_access_tracker["bookacall_button"] = {}
		global default_state
		self._bookacall_button = Button(new_state, default_state["bookacall_button"])
	...
	def _to_json_fields(self):
		return {
			...
			"Flex2": self._Flex2,
			"Flex3": self._Flex3,
			"home-hero-section": self._home-hero-section,
			"Flex29": self._Flex29,
			"Flex30": self._Flex30,
			"Flex31": self._Flex31,
			"Flex32": self._Flex32,
			...
			"services_button": self._services_button,
			"Button5": self._Button5,
			"blog_button": self._blog_button,
			"bookacall_button": self._bookacall_button,
